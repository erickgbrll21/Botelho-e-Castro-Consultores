  ...
  public: {
    Tables: {
      ...
      empresas: {
        ...
        Insert: Omit<Database["public"]["Tables"]["empresas"]["Row"], "id"> & {
          id?: string;
        };
      ...
      grupos_empresariais: {
        ...
        Update: Partial<Database["public"]["Tables"]["grupos_empresariais"]["Insert"]>;
      };
      quadro_socios: {
        Row: {
          id: string;
      ...
      empresa_usuarios: {
        ...
        Insert: Omit<Database["public"]["Tables"]["empresa_usuarios"]["Row"], "id"> & {
          id?: string;
        };
